...
provinces = ['BC', 'BT', 'GL', 'IS', 'NT', 'VN', 'VS', 'SV']
neighbors = [('BT', 'SV'), ('BT', 'IS'), ('SV', 'NT'), ('NT', 'IS'), ('SV', 'IS'), ('NT', 'BC'), ('NT', 'VS'), ('IS', 'VS'), ('BC', 'VN'), ('BC', 'VS'), ('VN', 'VS'), ('VN', 'GL'), ('GL', 'VS')]
...
response = sampler.sample(bqm, num_reads=20)         # doctest: +SKIP
